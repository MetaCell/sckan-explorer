...
export const MOCKED_composerStatement = {
    ...
    "sentence": {
        "id": 1885,
        "title": "neuron type bolew unbranched 12 created from neurondm on 20240208131816",
                ...
                "species": [
                    {
                        ...
                        "ontology_uri": "https://ontobee.org/ontology/NCBITaxon?iri=http://purl.obolibrary.org/obo/NCBITaxon_10141"
                    }
                ],
                "sex_id": 2,
                "sex": {
        ...
        "pmid_uri": ".",
        "pmcid_uri": ".",
        "doi_uri": "https://doi.org/http://uri.interlex.org/tgbugs/uris/readable/neuron-type-bolew-unbranched-12"
    },
    "knowledge_statement": "neuron type bolew unbranched 12",
    "tags": [
        {
            ...
            "anatomical_entities": [
                {
                    ...
                    "region_layer": null,
                    "synonyms": "carotid branch of glossopharyngeal nerve, Hering sinus nerve, ramus sinus carotici, ramus sinus carotici nervi glossopharyngei, ramus sinus carotici nervus glossopharyngei, sinus nerve of Hering"
                }
            ],
            "from_entities": [
                {
            ...
            "anatomical_entities": [
                {
                    ...
                    "region_layer": null,
                    "synonyms": "nuclei tractus solitarii, nucleus of the solitary tract, nucleus of the tractus solitarius, nucleus of tractus solitarius, nucleus solitarius, nucleus tracti solitarii, nucleus tractus solitarii, nucleus tractus solitarii medullae oblongatae, solitary nuclear complex, solitary nucleus, solitary tract nucleus"
                }
            ],
            "from_entities": [
                {
    ...
    "has_notes": true,
    "statement_preview": "In female Cavia porcellus, the enteric connection goes from inferior glossopharyngeal IX ganglion to carotid sinus or nucleus of solitary tract via carotid sinus nerve.\nThis ipsilateral motor connection projects from the inferior glossopharyngeal IX ganglion and is found on the left side of the body.\n It is described in This is a test model.",
    "errors": []
}