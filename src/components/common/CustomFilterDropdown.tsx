                ...
                >
                    {selectedOptions.length === 0 ? (
                        ...
                        <Box gap={0} display='flex' flexWrap='wrap' alignItems='center'>
                            ...
                            {selectedOptions?.length > 1 && <Typography sx={{
                                ...styles.chip,
                                display: 'flex',
                                alignItems: 'center',
                                padding: 0,
                    ...
                    {selectedOptions?.length ? <ClearOutlinedIcon onClick={(e) => {
                        e.stopPropagation();
                        onSelect([])
                    }} sx={{...styles.toggleIcon, color: primaryPurple600}}/> : open ?
                            ...
                            <TextField
                                ...
                                InputProps={{
                                    startAdornment: <InputAdornment position='start'><SearchIcon
                                        sx={{fontSize: '1rem', color: gray600}}/></InputAdornment>
                                }}
                            />
                        </Box>
                        {autocompleteOptions.length > 0 ? (
                            <>
                                <Box height='calc(100% - 2.8rem)' border={`0.0625rem solid ${gray100}`} borderTop={0}
                                                ...
                                                .map((option: Option) => (
                                                    ...
                                                    >
                                                        ...
                                                        <Typography whiteSpace='nowrap'
                                                                    variant="body2">{option?.id}</Typography>
                                                    </li>
                                                ))}
                                        </ul>
                                    </Box>
