...
interface DetailProps {
  keyName: string, sectionData: SectionDataType, value: string | number, labels: LabelsType, index: number
}
export const Detail = ({ keyName, sectionData, value, labels, index } : DetailProps) => (
  <Stack
    key={keyName}
    direction="row"
    alignItems="center"
    ...
    id={keyName}
  >
      <Typography variant='h5' fontWeight={500} color={gray700} sx={{
        '& .MuiSvgIcon-root': {
          fontSize: '1rem',
          marginLeft: '.5rem'
        },
